...
public class SamRecordTrackingBuffer {
    ...
    public SamRecordIndex next() {
        ...
        if (!headBlock.canEmit())
            throw new SAMException("Attempting to get a samRecordIndex from the SamRecordTrackingBuffer that has not been through " +
    ...
    public void setExamined(final SamRecordIndex samRecordIndex, final boolean examinedState) {
        ...
        if (null == block) {
            throw new SAMException("Attempted to set examined information on a samRecordIndex whose index is not found " +
